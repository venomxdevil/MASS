...
class Config(object):
    # Pyrogram Client
    API_ID    = int(os.environ.get("API_ID", "26696077"))  # ⚠️ Required
    API_HASH  = os.environ.get("API_HASH", "5bcb1081ae8d83ac6f9669cea986b6c5") # ⚠️ Required
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7212332213:AAHajuZYpGS4nabE4Oay4--bk12qsRUjHpw") # ⚠️ Required
    
    # Other Configs
    BOT_START_TIME = time.time()
    OWNER    = int(os.environ.get("OWNER", "7534773118"))  # ⚠️ Required
    SUDO = list(map(int, os.environ.get("SUDO", "7534773118").split()))  # ⚠️ Required
    # Web Response Config
...
☛ For e.g :- <code> @ </code> or <code> https:/t.me/IM4RC0 </code>
"""
...
Tʜɪs ʙᴏᴛ ɪs sᴏʟᴇʟʏ ᴄʀᴇᴀᴛᴇ ᴏʀ ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ :- @IM4RC0
"""
